...
extern SILK_DLL_EXPORT SKP_int32 silk_decode_file(const char *inputfile, const char *outputfile, SKP_int32 ar, SKP_float loss);
...
extern SILK_DLL_EXPORT SKP_int32 silk_encode_file(const char *inputfile, const char *outputfile, SKP_int32 Fs_API, SKP_int32 rate, SKP_int32 packetlength, SKP_int32 complecity,
...
#define SILK_FREE_OK 0
#define SILK_FREE_ERROR 1
/* Free memory */
extern SILK_DLL_EXPORT SKP_int32 silk_free(void* buffer);
